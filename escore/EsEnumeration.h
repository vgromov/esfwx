...
protected:
  ...
  ES_NO_DEFAULT_CTR(EsEnumeration);
  ES_NON_COPYABLE(EsEnumeration);
};
...
// Alias to an empty enumeration description
#define NO_ENUM_DESCR NO_CLASS_DESCR
...
#define ES_ENUM_ITEM_V(ScriptEnumVar, ItemName) \
  ScriptEnumVar->valueGet( ES_STRINGIZE(ItemName) )
//---------------------------------------------------------------------------

inline EsVariant EsScriptEnumItemGet(const EsVariant& script, const EsString& enumName, const EsString& itemName)
{
  return script.call(
    esT("enumerationEval"),
    enumName + esT("$$") + itemName
  );
}

#define ES_SCRIPT_ENUM_ITEM(ScriptVar, EnumerationName, ItemName) \
  EsScriptEnumItemGet( ScriptVar, ES_STRINGIZE(EnumerationName), ES_STRINGIZE(ItemName) )

#define ES_SCRIPT_ENUM_ITEM_LABEL(ScriptVar, EnumerationName, ItemName) \
  EsScriptEnumItemGet( ScriptVar, ES_STRINGIZE(EnumerationName), ES_STRINGIZE(ItemName)  esT("$$label") )
//--------------------------------------------------------------------------------

inline EsString EsScriptEnumValueLabelGet(const EsVariant& script, const EsString& enumName, const EsVariant& value)
{
  return script.call(
    esT("enumerationGet"),
    enumName
...
#define ES_SCRIPT_ENUM_VALUE_LABEL(ScriptVar, EnumerationName, Value) \
  EsScriptEnumValueLabelGet( ScriptVar, ES_STRINGIZE(EnumerationName), Value )
//---------------------------------------------------------------------------
