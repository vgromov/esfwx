...
{
  std::unique_ptr<EsCRC8> p = ES_MAKE_UNIQUE( EsCRC8 );
  ES_ASSERT(p);
...
{
  std::unique_ptr<EsCRC8> p = ES_MAKE_UNIQUE(
    EsCRC8,
    nullptr, 
    0, 
    initialSum
...
{
  std::unique_ptr<EsChecksum16> p = ES_MAKE_UNIQUE( EsChecksum16 );
  ES_ASSERT(p);
...
{
  std::unique_ptr<EsChecksum16> p = ES_MAKE_UNIQUE(
    EsChecksum16,
    buff
  );
  ES_ASSERT(p);
...
{ 
  std::unique_ptr<EsCRC16_CCIITT> p = ES_MAKE_UNIQUE( EsCRC16_CCIITT );
  ES_ASSERT(p);
...
{ 
  std::unique_ptr<EsCRC16_CCIITT> p = ES_MAKE_UNIQUE( 
    EsCRC16_CCIITT,
    nullptr, 
    0, 
    initialSum
...
{
  std::unique_ptr<EsCRC32_IEEE802_3> p = ES_MAKE_UNIQUE( EsCRC32_IEEE802_3 );
  ES_ASSERT(p);
...
{ 
  std::unique_ptr<EsCRC32_IEEE802_3> p = ES_MAKE_UNIQUE(
    EsCRC32_IEEE802_3,
    nullptr, 
    0, 
    initialSum
