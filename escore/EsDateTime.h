...
public:
  ...
  EsTimeSpan& operator= (const EsTimeSpan& src);
...
public:
  ...
  /// @brief DateTime value composition
  /// Compose a EsDateTime object from separate components
  ///
  /// @param [in]    long  year
  /// @param [in]    ulong month, [1 .. 12]
  /// @param [in]    ulong dayOfMonth, [1 .. appropriate maximum day for a month]
  /// @param [in]    ulong hour
  ...
  /// @brief DateTime Time portion composition
  /// Compose a EsDateTime object from separate components
  ///
  /// @param [in]    ulong hour
  /// @param [in]    ulong minute
  ...
  /// @param [in]    ulong millisecond
  ///
  void compose(ulong hour, ulong minute, ulong second, ulong millisecond);
  ...
  EsDateTime& operator= (const EsDateTime& src);
