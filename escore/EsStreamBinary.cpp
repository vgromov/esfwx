...
class EsStreamBinaryCtorAcc : public EsStreamBinary
{
public:
  EsStreamBinaryCtorAcc(ulong flags, ulong version, const EsVariant& src, const EsBaseIntfPtr& factory) :
  EsStreamBinary(
    flags,
    version,
    src,
...
{
  std::unique_ptr<EsStreamBinaryCtorAcc> p = ES_MAKE_UNIQUE(
    EsStreamBinaryCtorAcc,
    flags,
    version,
    src,
    factory
