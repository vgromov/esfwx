...
ES_REFLECTION_REGISTRAR_BEGIN(esscript)
  ...
  ES_REFLECTION_REGISTRAR_ENTRY(EsReflection::EsScriptExceptionCode)
...
class EsScriptCtorAcc : public EsScript
{
public:
  EsScriptCtorAcc(const EsScriptIntf::Ptr& master) :
  EsScript(master)
  {}
};
//---------------------------------------------------------------------------
...
ES_DECL_BASE_CLASS_INFO_CUSTOM_BEGIN(EsScript, NO_CLASS_DESCR)
  ...
  ES_DECL_REFLECTED_INTF_METHOD_INFO(EsScript, EsScriptIntf, enumerationGet, EsVariant_CallConst_cr_EsString, NO_METHOD_DESCR)
  ES_DECL_REFLECTED_INTF_METHOD_INFO(EsScript, EsScriptIntf, enumerationEval, EsVariant_CallConst_cr_EsString, NO_METHOD_DESCR)
  ...
  ES_DECL_PROP_INFO(            EsScript, translatablesGenerate,      bool,           NO_PROPERTY_LABEL, EsVariant(false), NO_PROPERTY_DESCR)
  ES_DECL_PROP_INFO(            EsScript, debugLogSuppress,           bool,           NO_PROPERTY_LABEL, EsVariant(false), NO_PROPERTY_DESCR)
  ES_DECL_PROP_INFO(            EsScript, debugLogSuppressInclFirst,  bool,           NO_PROPERTY_LABEL, EsVariant(true), NO_PROPERTY_DESCR)
  ES_DECL_PROP_INFO(            EsScript, debugLogSuppressIncl,       EsStringArray,  NO_PROPERTY_LABEL, esVT(".*"), NO_PROPERTY_DESCR)
  ES_DECL_PROP_INFO(            EsScript, debugLogSuppressExcl,       EsStringArray,  NO_PROPERTY_LABEL, EsString::nullArray(), NO_PROPERTY_DESCR)
...
{
  std::unique_ptr<EsScriptCtorAcc> p = ES_MAKE_UNIQUE(
    EsScriptCtorAcc,
    master
  );
  ES_ASSERT(p);
...
EsVariant EsScript::enumerationEval(const EsString& enumValExpr) const
{
  EsRegEx re(
    esT("([_a-zA-Z]+[_a-zA-Z0-9]*)\\$\\$([_a-zA-Z]+[_a-zA-Z0-9]*)(\\$\\$label)?")
  );

  re.set_text(enumValExpr);
  if( !re.get_matches() )
...
EsVariant EsScript::enumerationGet(const EsString& name) const
{
...
bool EsScript::get_translatablesGenerate() const
{
  return m_params.m_translatablesSave;
}
//---------------------------------------------------------------------------

void EsScript::set_translatablesGenerate(const bool& generate)
{
  m_params.m_translatablesSave = generate;
}
//--------------------------------------------------------------------------------

bool EsScript::get_debugLogSuppress() const
{
  return m_params.m_debugLogSuppress;
}
//---------------------------------------------------------------------------

void EsScript::set_debugLogSuppress(const bool& suppress)
{
  m_params.m_debugLogSuppress = suppress;
}
//--------------------------------------------------------------------------------

bool EsScript::get_debugLogSuppressInclFirst() const
{
  return m_params.m_dbgLogSuppressInclFirst;
}
//--------------------------------------------------------------------------------

void EsScript::set_debugLogSuppressInclFirst(const bool& inclFirst)
{
  m_params.m_dbgLogSuppressInclFirst = inclFirst;
}
//---------------------------------------------------------------------------

EsStringArray EsScript::get_debugLogSuppressIncl() const
{
  return m_params.m_dbgLogSuppressIncl;
}
//---------------------------------------------------------------------------

void EsScript::set_debugLogSuppressIncl(const EsStringArray& rulesIncl)
{
  m_params.m_dbgLogSuppressIncl = rulesIncl;
}
//--------------------------------------------------------------------------------

EsStringArray EsScript::get_debugLogSuppressExcl() const
{
  return m_params.m_dbgLogSuppressExcl;
}
//---------------------------------------------------------------------------

void EsScript::set_debugLogSuppressExcl(const EsStringArray& rulesExcl)
{
  m_params.m_dbgLogSuppressExcl = rulesExcl;
}
//--------------------------------------------------------------------------------
...
{
  std::unique_ptr<EsScriptlet> scl = ES_MAKE_UNIQUE( 
    EsScriptlet,
    m_machine, 
    name, 
    src, 
...
bool EsScript::shouldSuppressDbgLog(const EsString& file, bool inclFirst, const EsString::Array& incl, const EsString::Array& excl)
{
  EsRegEx re;
  bool result = true;
  if(inclFirst)
...
bool EsScript::shouldSuppressDbgLog(const EsString& file) const
{
  if(!m_params.m_debugLogSuppress)
    return false;
    
  return shouldSuppressDbgLog(
    file,
    m_params.m_dbgLogSuppressInclFirst,
    m_params.m_dbgLogSuppressIncl,
    m_params.m_dbgLogSuppressExcl
  );
}
//---------------------------------------------------------------------------
