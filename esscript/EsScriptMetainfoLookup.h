...
public:
  ...
  /// Return only syntactically correct constants names
  ES_DECL_REFLECTED_CONST_METHOD1(EsStringArray, constantsFindSyntaxRestricted, cr_EsString);
...
private:
  ES_NO_DEFAULT_CTR(EsScriptMetainfoLookup);
  ES_NON_COPYABLE(EsScriptMetainfoLookup);
};
