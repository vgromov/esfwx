...
GRAMMAR_RULE(externEnumValAcc)
GRAMMAR_RULE(externEnumValLblAcc)
GRAMMAR_RULE(lrhs)

// Operators
GRAMMAR_RULE(opAssign)    // 31
...
GRAMMAR_RULE(stmtExternEnumDecl)
GRAMMAR_RULE(stmtExternObjDecl)
...
GRAMMAR_RULE(stmtObjMemberVarDecl) // 96
