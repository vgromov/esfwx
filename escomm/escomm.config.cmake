...
set(ESCOMM_USE_BLUETOOTH 1 CACHE BOOL "Use classic bluetooth IO")
set(ESCOMM_USE_BLUETOOTH_LE 1 CACHE BOOL "Use BluetoothLE IO")
...
set(ESCOMM_USE_RPC 1 CACHE BOOL "Use ES Remote Procedure Call engine over IO channels")
...
set(ES_COMM_USE_RPC ${ESCOMM_USE_RPC})

# Set-up ESCOMM binary version naming
#
set(ESCOMM_VERSION_SUFFIX "${ESFWX_VERSION_SUFFIX}_${component_BUILD_NUM}" CACHE INTERNAL "")
