...
class EsFtdiDeviceMpsseI2cCtorAcc : public EsFtdiDeviceMpsseI2c
{
public:
  EsFtdiDeviceMpsseI2cCtorAcc(EsFtdiDriver* owner, const EsFtdiDriver::FT_DEVICE_LIST_INFO_NODE& node) :
  EsFtdiDeviceMpsseI2c(
    owner,
    node
  )
  {}
...
{
  std::unique_ptr<EsFtdiDeviceMpsseI2cCtorAcc> ptr = ES_MAKE_UNIQUE(
    EsFtdiDeviceMpsseI2cCtorAcc,
    &owner,
    node
  );
  ES_ASSERT(ptr);
