...
#if defined(ES_COMM_USE_CHANNEL_UART) || \
    defined(ES_COMM_USE_CHANNEL_EKONNECT) || \
    defined(ES_COMM_USE_CHANNEL_IO_SOCKET) || \
    defined(ES_COMM_USE_CHANNEL_BLUETOOTH) || \
    defined(ES_COMM_USE_CHANNEL_BLUETOOTH_LE) || \
    defined(ES_COMM_USE_CHANNEL_STUB)
# define ES_COMM_USE_ANY_CHANNEL
#endif
