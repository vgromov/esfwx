...
// 
ES_DECL_EXPORTED_ENUMERATION_BEGIN(ESCOMM_CLASS, EsRpcStatus)
  ES_DECL_ENUMERATION_ITEM_LABELLED(OK,                 RpcStatus::RpcOK,                 esT("RPC succeeded"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(NotImplemented,     RpcStatus::RpcNotImplemented,     esT("RPC is not implemented/not registered"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(StackCorrupt,       RpcStatus::RpcStackCorrupt,       esT("RPC stack is corrupt and unusable"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(TimedOut,           RpcStatus::RpcTimedOut,           esT("RPC execution was prematurely cancelled due to timeout"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(StackOverflow,      RpcStatus::RpcStackOverflow,      esT("Too many RPC parameters specified, stack overflow occured"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(UnknownSignature,   RpcStatus::RpcUnknownSignature,   esT("RPC signature is unknown"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(SignatureMismatch,  RpcStatus::RpcSignatureMismatch,  esT("RPC signature of caller and callee do not match each other"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(ResponseIdMismatch, RpcStatus::RpcResponseIdMismatch, esT("RPC procedure ID of response does not match one of request"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(CommunicationError, RpcStatus::RpcCommunicationError, esT("RPC failed due to communication layer"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(NotReady,           RpcStatus::RpcNotReady,           esT("RPC not ready to respond"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param0ValueError,   RpcStatus::RpcParam0ValueError,   esT("RPC parameter 0 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param1ValueError,   RpcStatus::RpcParam1ValueError,   esT("RPC parameter 1 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param2ValueError,   RpcStatus::RpcParam2ValueError,   esT("RPC parameter 2 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param3ValueError,   RpcStatus::RpcParam3ValueError,   esT("RPC parameter 3 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param4ValueError,   RpcStatus::RpcParam4ValueError,   esT("RPC parameter 4 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Param5ValueError,   RpcStatus::RpcParam5ValueError,   esT("RPC parameter 5 value is wrong"))
  ES_DECL_ENUMERATION_ITEM_LABELLED(Cancelled,          RpcStatus::RpcCancelled,          esT("RPC execution is cancelled"))
