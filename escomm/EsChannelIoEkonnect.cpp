...
class EsChannelIoEkonnectCtorAcc : public EsChannelIoEkonnect
{
public:
  EsChannelIoEkonnectCtorAcc() :
  EsChannelIoEkonnect()
  {}
};
//---------------------------------------------------------------------------
...
{
  std::unique_ptr<EsChannelIoEkonnectCtorAcc> chnl = ES_MAKE_UNIQUE(EsChannelIoEkonnectCtorAcc);
  ES_ASSERT(chnl);
