...
protected:
  ...
  protected:
    ...
    ES_NO_DEFAULT_CTR(Listener);
    ES_NON_COPYABLE(Listener);
  ...
  protected:
    ...
    ES_NO_DEFAULT_CTR(Handler);
    ES_NON_COPYABLE(Handler);
...
protected:
  ...
  ES_NON_COPYABLE(EsSocketServer);
};
//---------------------------------------------------------------------------
