...
class EsChannelIoUartCtorAcc : public EsChannelIoUart
{
public:
  EsChannelIoUartCtorAcc() :
  EsChannelIoUart()
  {}
};
//---------------------------------------------------------------------------
...
{
  std::unique_ptr<EsChannelIoUartCtorAcc> chnl = ES_MAKE_UNIQUE( EsChannelIoUartCtorAcc );
  ES_ASSERT(chnl);
  chnl->m_dynamic = true;
