...
class EsFtdiDeviceCtorAcc : public EsFtdiDevice
{
public:
  EsFtdiDeviceCtorAcc(EsFtdiDriver* owner, const EsFtdiDriver::FT_DEVICE_LIST_INFO_NODE& node ) :
  EsFtdiDevice(
    owner,
    node
  )
...
{
  std::unique_ptr<EsFtdiDeviceCtorAcc> ptr = ES_MAKE_UNIQUE(
    EsFtdiDeviceCtorAcc,
    &owner,
    node
  );
