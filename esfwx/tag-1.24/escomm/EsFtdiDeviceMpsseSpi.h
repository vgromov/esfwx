...
public:
  ...
  ES_DECL_INTF_METHOD(void, close)();
  ...
  ES_DECL_INTF_METHOD(EsFtdiMpsseSpiIntf::CPOL_CPHA, modeGet)() const;
  ES_DECL_INTF_METHOD(void, modeSet)( EsFtdiMpsseSpiIntf::CPOL_CPHA opts );

  /// SPI CS line selector control
  ES_DECL_INTF_METHOD(EsFtdiMpsseSpiIntf::CS_LINE, csLineCtlGet)() const;
  ES_DECL_INTF_METHOD(void, csLineCtlSet)(EsFtdiMpsseSpiIntf::CS_LINE ctl);
  ...
  ES_DECL_INTF_METHOD(bool, csLineActiveHighGet)() const;
  ES_DECL_INTF_METHOD(void, csLineActiveHighSet)(bool set);
  ...
  ///
  ES_DECL_INTF_METHOD(esU8, pinsDirInitGet)() const;
  ES_DECL_INTF_METHOD(void, pinsDirInitSet)(esU8 set);

  ES_DECL_INTF_METHOD(esU8, pinsDirFinalGet)() const;
  ES_DECL_INTF_METHOD(void, pinsDirFinalSet)(esU8 set);

  ES_DECL_INTF_METHOD(esU8, pinsStateInitGet)() const;
  ES_DECL_INTF_METHOD(void, pinsStateInitSet)(esU8 set);

  ES_DECL_INTF_METHOD(esU8, pinsStateFinalGet)() const;
  ES_DECL_INTF_METHOD(void, pinsStateFinalSet)(esU8 set);

  // Pins current direction and state
  ES_DECL_INTF_METHOD(esU8, pinsDirCurrentGet)() const;
  ES_DECL_INTF_METHOD(esU8, pinsStateCurrentGet)() const;
  ES_DECL_INTF_METHOD(bool, pinsStateCurrentSet)(esU8 set);

  /// Return current MISO line state
  ES_DECL_REFLECTED_INTF_METHOD0(bool, misoPoll);

  /// Write data to SPI channel, using SPI transfer options - see corresponding enum decl
  /// Returned is count of bytes written
  ///
  ES_DECL_INTF_METHOD(esU32, write)(EsBinBuffer::const_pointer src, esU32 len, esU32 opts);
  ES_DECL_REFLECTED_INTF_METHOD2(esU32, write, cr_EsBinBuffer, esU32);
  ...
  ///
  ES_DECL_INTF_METHOD(esU32, read)(EsBinBuffer::pointer dest, esU32 len, esU32 opts);
  ES_DECL_REFLECTED_INTF_METHOD2(EsBinBuffer, read, esU32, esU32);

  /// Perform combined SPI read-write call
  ES_DECL_INTF_METHOD(esU32, readWrite)(EsBinBuffer::const_pointer src, EsBinBuffer::pointer dest, esU32 len, esU32 opts);
  ES_DECL_REFLECTED_INTF_METHOD2(EsBinBuffer, readWrite, cr_EsBinBuffer, esU32);

  /// Set state of CS line
  ES_DECL_REFLECTED_INTF_METHOD1(void, csSet, bool);
