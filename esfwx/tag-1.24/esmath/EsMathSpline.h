...
public:
  EsMathSplineNode();
  EsMathSplineNode(double x, double xp, double a, double b, double c, double d);
  EsMathSplineNode(const EsMathSplineNode& src);
  EsMathSplineNode& operator=(const EsMathSplineNode& src);

  inline double x() const { return m_x; }
  inline double xp() const { return m_xp; }
...
private:
  ...
  EsMathSpline(const EsMathSpline&);
  const EsMathSpline& operator=(const EsMathSpline&);
