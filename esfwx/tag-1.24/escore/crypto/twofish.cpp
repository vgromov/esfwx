...
void Twofish::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int keylength, const NameValuePairs &)
{
...
void Twofish::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 x, y, a, b, c, d;
...
void Twofish::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 x, y, a, b, c, d;
