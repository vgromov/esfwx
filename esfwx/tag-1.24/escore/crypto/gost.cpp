...
const CryptoPP::byte GOST::Base::sBox[8][16]={
...
void GOST::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int length, const NameValuePairs &)
{
...
void GOST::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 n1, n2, t;
...
void GOST::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 n1, n2, t;
