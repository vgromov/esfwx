...
void ThreeWay::Base::UncheckedSetKey(const CryptoPP::byte *uk, unsigned int length, const NameValuePairs &params)
{
...
void ThreeWay::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
...
void ThreeWay::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
