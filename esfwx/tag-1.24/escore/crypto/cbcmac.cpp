...
void CBC_MAC_Base::UncheckedSetKey(const CryptoPP::byte *key, unsigned int length, const NameValuePairs &params)
{
...
void CBC_MAC_Base::Update(const CryptoPP::byte *input, size_t length)
{
...
void CBC_MAC_Base::TruncatedFinal(CryptoPP::byte *mac, size_t size)
{
