...
size_t BaseN_Encoder::Put2(const CryptoPP::byte *begin, size_t length, int messageEnd, bool blocking)
{
  FILTER_BEGIN;
...
size_t BaseN_Decoder::Put2(const CryptoPP::byte *begin, size_t length, int messageEnd, bool blocking)
{
  FILTER_BEGIN;
  while (m_inputPosition < length)
  {
...
void BaseN_Decoder::InitializeDecodingLookupArray(int *lookup, const CryptoPP::byte *alphabet, unsigned int base, bool caseInsensitive)
{
...
size_t Grouper::Put2(const CryptoPP::byte *begin, size_t length, int messageEnd, bool blocking)
{
  FILTER_BEGIN;
  if (m_groupSize)
  {
