...
bool ECP::DecodePoint(ECP::Point &P, const CryptoPP::byte *encodedPoint, size_t encodedPointLen) const
{
...
void ECP::EncodePoint(CryptoPP::byte *encodedPoint, const Point &P, bool compressed) const
{
