...
unsigned int Socket::Send(const CryptoPP::byte* buf, size_t bufLen, int flags)
{
  CRYPTOPP_ASSERT(m_s != INVALID_SOCKET);
...
unsigned int Socket::Receive(CryptoPP::byte* buf, size_t bufLen, int flags)
{
  CRYPTOPP_ASSERT(m_s != INVALID_SOCKET);
...
bool SocketReceiver::Receive(CryptoPP::byte* buf, size_t bufLen)
{
...
void SocketSender::Send(const CryptoPP::byte* buf, size_t bufLen)
{
