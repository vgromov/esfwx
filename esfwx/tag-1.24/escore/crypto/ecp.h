...
public:
  ...
  bool DecodePoint(Point &P, const CryptoPP::byte *encodedPoint, size_t len) const;
  void EncodePoint(CryptoPP::byte *encodedPoint, const Point &P, bool compressed) const;
