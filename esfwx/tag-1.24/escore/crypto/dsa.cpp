...
size_t DSAConvertSignatureFormat(CryptoPP::byte *buffer, size_t bufferSize, DSASignatureFormat toFormat, const CryptoPP::byte *signature, size_t signatureLen, DSASignatureFormat fromFormat)
{
  Integer r, s;
