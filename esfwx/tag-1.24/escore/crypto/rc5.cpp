...
void RC5::Base::UncheckedSetKey(const CryptoPP::byte *k, unsigned int keylen, const NameValuePairs &params)
{
...
void RC5::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
...
void RC5::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
