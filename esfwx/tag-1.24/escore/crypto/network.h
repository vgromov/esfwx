...
public:
  ...
  size_t GeneralPump2(lword &byteCount, bool blockingOutput=true, unsigned long maxTime=INFINITE_TIME, bool checkDelimiter=false, CryptoPP::byte delimiter='\n');

  lword GeneralPump(lword maxSize=LWORD_MAX, unsigned long maxTime=INFINITE_TIME, bool checkDelimiter=false, CryptoPP::byte delimiter='\n')
  {
  ...
  lword PumpLine(CryptoPP::byte delimiter='\n', lword maxSize=1024)
...
protected:
  virtual size_t DoPump(lword &byteCount, bool blockingOutput,
    unsigned long maxTime, bool checkDelimiter, CryptoPP::byte delimiter) =0;
...
public:
  ...
  virtual bool Receive(CryptoPP::byte* buf, size_t bufLen) =0;
...
public:
  ...
  virtual bool MustWaitForResult() {return false;}
  virtual void Send(const CryptoPP::byte* buf, size_t bufLen) =0;
...
protected:
  size_t DoPump(lword &byteCount, bool blockingOutput, unsigned long maxTime, bool checkDelimiter, CryptoPP::byte delimiter);
