...
public:
  ...
  void SetKey(const CryptoPP::byte *userKey, size_t keylength, const NameValuePairs &params);
  ...
  void TruncatedFinal(CryptoPP::byte *mac, size_t macSize);

protected:
  void AuthenticateData(const CryptoPP::byte *data, size_t len);
  ...
  virtual void SetKeyWithoutResync(const CryptoPP::byte *userKey, size_t keylength, const NameValuePairs &params) =0;
  virtual void Resync(const CryptoPP::byte *iv, size_t len) =0;
  virtual size_t AuthenticateBlocks(const CryptoPP::byte *data, size_t len) =0;
  virtual void AuthenticateLastHeaderBlock() =0;
  virtual void AuthenticateLastConfidentialBlock() {}
  virtual void AuthenticateLastFooterBlock(CryptoPP::byte *mac, size_t macSize) =0;
