...
bool EC2N::DecodePoint(EC2N::Point &P, const CryptoPP::byte *encodedPoint, size_t encodedPointLen) const
{
...
void EC2N::EncodePoint(CryptoPP::byte *encodedPoint, const Point &P, bool compressed) const
{
