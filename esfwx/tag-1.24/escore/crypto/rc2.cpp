...
void RC2::Base::UncheckedSetKey(const CryptoPP::byte *key, unsigned int keyLen, const NameValuePairs &params)
{
  ...
  CryptoPP::byte TM = CryptoPP::byte((int)255 >> ((8-(effectiveLen%8))%8));
...
void RC2::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word16 R0, R1, R2, R3;
...
void RC2::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word16 R0, R1, R2, R3;
  Block::Get(inBlock)(R0)(R1)(R2)(R3);
