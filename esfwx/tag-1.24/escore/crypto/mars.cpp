...
void MARS::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int length, const NameValuePairs &)
{
...
void MARS::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  unsigned int i;
...
void MARS::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  unsigned int i;
  word32 a, b, c, d, l, m, r, t;
  const word32 *k = m_k;
