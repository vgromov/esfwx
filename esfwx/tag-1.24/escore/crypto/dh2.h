...
public:
  ...
  void GenerateStaticKeyPair(RandomNumberGenerator &rng, CryptoPP::byte *privateKey, CryptoPP::byte *publicKey) const
  ...
  void GenerateEphemeralKeyPair(RandomNumberGenerator &rng, CryptoPP::byte *privateKey, CryptoPP::byte *publicKey) const
