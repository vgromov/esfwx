...
void Blowfish::Base::UncheckedSetKey(const CryptoPP::byte *key_string, unsigned int keylength, const NameValuePairs &)
{
...
void Blowfish::Base::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
