...
void Serpent_KeySchedule(word32 *k, unsigned int rounds, const CryptoPP::byte *userKey, size_t keylen)
{
...
void Serpent::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int keylen, const NameValuePairs &)
{
...
void Serpent::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 a, b, c, d, e;
...
void Serpent::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 a, b, c, d, e;
