...
void IDEA::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int length, const NameValuePairs &)
{
...
void IDEA::Base::EnKey (const CryptoPP::byte *userKey)
{
  unsigned int i;
...
void IDEA::Base::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
