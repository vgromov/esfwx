...
void CAST128::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 t, l, r;
...
void CAST128::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 t, l, r;
...
void CAST128::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int keylength, const NameValuePairs &)
{
...
void CAST256::Base::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
  word32 t, block[4];
...
void CAST256::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int keylength, const NameValuePairs &)
{
  AssertValidKeyLength(keylength);
