...
static const CryptoPP::byte s_s0[256] = {
...
static const CryptoPP::byte s_s1[256] = {
...
void SEED::Base::UncheckedSetKey(const CryptoPP::byte *userKey, unsigned int length, const NameValuePairs& /*params*/)
{
...
void SEED::Base::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
