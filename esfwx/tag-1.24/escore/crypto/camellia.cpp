...
void Camellia::Base::UncheckedSetKey(const CryptoPP::byte *key, unsigned int keylen, const NameValuePairs &)
{
...
#define CALC_ADDR2(base, i, j)  ((CryptoPP::byte *)(base)+8*(i)+4*(j)+((-16*(i))&m))
...
void Camellia::Base::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
...
const CryptoPP::byte Camellia::Base::s1[256] =
{
