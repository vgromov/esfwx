...
public:
  ...
  bool TruncatedVerify(const CryptoPP::byte *digest, size_t digestLength)
...
public:
  ...
  TruncatedHashTemplate(const CryptoPP::byte *key, size_t keyLength, unsigned int digestSize)
