...
template<> const CryptoPP::byte PKCS_DigestDecoration<Weak1::MD2>::decoration[] = {0x30,0x20,0x30,0x0c,0x06,0x08,0x2a,0x86,0x48,0x86,0xf7,0x0d,0x02,0x02,0x05,0x00,0x04,0x10};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<Weak1::MD5>::decoration[] = {0x30,0x20,0x30,0x0c,0x06,0x08,0x2a,0x86,0x48,0x86,0xf7,0x0d,0x02,0x05,0x05,0x00,0x04,0x10};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<RIPEMD160>::decoration[] = {0x30,0x21,0x30,0x09,0x06,0x05,0x2b,0x24,0x03,0x02,0x01,0x05,0x00,0x04,0x14};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<Tiger>::decoration[] = {0x30,0x29,0x30,0x0D,0x06,0x09,0x2B,0x06,0x01,0x04,0x01,0xDA,0x47,0x0C,0x02,0x05,0x00,0x04,0x18};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<SHA1>::decoration[] = {0x30,0x21,0x30,0x09,0x06,0x05,0x2B,0x0E,0x03,0x02,0x1A,0x05,0x00,0x04,0x14};
template<> const unsigned int PKCS_DigestDecoration<SHA1>::length = (unsigned int)sizeof(PKCS_DigestDecoration<SHA1>::decoration);

template<> const CryptoPP::byte PKCS_DigestDecoration<SHA224>::decoration[] = {0x30,0x2d,0x30,0x0d,0x06,0x09,0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x02,0x04,0x05,0x00,0x04,0x1c};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<SHA256>::decoration[] = {0x30,0x31,0x30,0x0d,0x06,0x09,0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x02,0x01,0x05,0x00,0x04,0x20};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<SHA384>::decoration[] = {0x30,0x41,0x30,0x0d,0x06,0x09,0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x02,0x02,0x05,0x00,0x04,0x30};
...
template<> const CryptoPP::byte PKCS_DigestDecoration<SHA512>::decoration[] = {0x30,0x51,0x30,0x0d,0x06,0x09,0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x02,0x03,0x05,0x00,0x04,0x40};
...
template<> const CryptoPP::byte EMSA2HashId<SHA1>::id = 0x33;
template<> const CryptoPP::byte EMSA2HashId<SHA224>::id = 0x38;
template<> const CryptoPP::byte EMSA2HashId<SHA256>::id = 0x34;
template<> const CryptoPP::byte EMSA2HashId<SHA384>::id = 0x36;
template<> const CryptoPP::byte EMSA2HashId<SHA512>::id = 0x35;
#endif
...
void PKCS_EncryptionPaddingScheme::Pad(RandomNumberGenerator& rng, const CryptoPP::byte *input, size_t inputLen, CryptoPP::byte *pkcsBlock, size_t pkcsBlockLen, const NameValuePairs& parameters) const
{
  ...
  for (unsigned i = 1; i < pkcsBlockLen-inputLen-1; i++)
    pkcsBlock[i] = (CryptoPP::byte)rng.GenerateWord32(1, 0xff);

  pkcsBlock[pkcsBlockLen-inputLen-1] = 0;     // separator
  memcpy(pkcsBlock+pkcsBlockLen-inputLen, input, inputLen);
}

DecodingResult PKCS_EncryptionPaddingScheme::Unpad(const CryptoPP::byte *pkcsBlock, size_t pkcsBlockLen, CryptoPP::byte *output, const NameValuePairs& parameters) const
{
  CRYPTOPP_UNUSED(parameters);
  bool invalid = false;
  ...
  CryptoPP::byte *representative, size_t representativeBitLength) const
{
  ...
  CryptoPP::byte *pPadding = representative + 1;
  CryptoPP::byte *pDigest = representative + pkcsBlockLen - digestSize;
  CryptoPP::byte *pHashId = pDigest - hashIdentifier.second;
  CryptoPP::byte *pSeparator = pHashId - 1;
