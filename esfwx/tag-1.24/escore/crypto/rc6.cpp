...
void RC6::Base::UncheckedSetKey(const CryptoPP::byte *k, unsigned int keylen, const NameValuePairs &params)
{
...
void RC6::Enc::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
...
void RC6::Dec::ProcessAndXorBlock(const CryptoPP::byte *inBlock, const CryptoPP::byte *xorBlock, CryptoPP::byte *outBlock) const
{
