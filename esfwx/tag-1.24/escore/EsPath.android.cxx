...
#else
# error EsPath::stdAppDataGet is not implemented for this OS
#endif
}
//---------------------------------------------------------------------------
...
#else
# error EsPath::stdLocalAppDataGet is not implemented for this OS
#endif
}
//---------------------------------------------------------------------------
...
#else
# error EsPath::stdDocsGet is not implemented for this OS
#endif
}
//---------------------------------------------------------------------------
...
#else
# error EsPath::stdPublicDocsGet is not implemented for this OS
#endif
}
//---------------------------------------------------------------------------
