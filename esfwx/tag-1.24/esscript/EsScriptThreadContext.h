...
public:
  ~EsScriptThreadContext() ES_NOTHROW;
...
private:
  ...
  EsScriptCodeSectionScope() ES_REMOVEDECL;
  EsScriptCodeSectionScope(const EsScriptCodeSectionScope&) ES_REMOVEDECL;
  const EsScriptCodeSectionScope& operator= (const EsScriptCodeSectionScope&) ES_REMOVEDECL;
