...
*/
#ifndef _lpc_21_isp_h_
#define _lpc_21_isp_h_
...
void AppDebugPrintf(ISP_ENVIRONMENT* env, int level, const char *fmt, ...);
...
int AppSyncing(ISP_ENVIRONMENT *IspEnvironment, int trials);
void AppWritten(ISP_ENVIRONMENT *IspEnvironment, int size);
...
void DumpString(ISP_ENVIRONMENT *IspEnvironment, int level, const void *s, size_t size, const char *prefix_string);
