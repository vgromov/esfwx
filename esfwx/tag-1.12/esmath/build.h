...
#define COMPONENT_DESCRIPTION_STRING	wxT("Math Library")
#define COMPONENT_INTERNAL_NAME				wxT("esmath")
#define COMPONENT_ORIGINAL_NAME				wxT("esmath.dll")
