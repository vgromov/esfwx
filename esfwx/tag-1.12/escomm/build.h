...
#define COMPONENT_DESCRIPTION_STRING	wxT("Communications Library")
#define COMPONENT_INTERNAL_NAME				wxT("escomm")
#define COMPONENT_ORIGINAL_NAME				wxT("escomm.dll")
