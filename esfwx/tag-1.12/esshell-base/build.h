...
#define COMPONENT_DESCRIPTION_STRING	wxT("EsShell GUI Base Library")
#define COMPONENT_INTERNAL_NAME				wxT("esshell-base")
#define COMPONENT_ORIGINAL_NAME				wxT("esshell-base.dll")
