...
#define COMPONENT_DESCRIPTION_STRING	wxT("Scripting Library")
#define COMPONENT_INTERNAL_NAME				wxT("esscript")
#define COMPONENT_ORIGINAL_NAME				wxT("esscript.dll")
