...
#define COMPONENT_DESCRIPTION_STRING	wxT("Charting Library")
#define COMPONENT_INTERNAL_NAME				wxT("eschart")
#define COMPONENT_ORIGINAL_NAME				wxT("eschart.dll")
