...
ES_DECL_EXPORTED_REFLECTED_SERVICES_BEGIN( EsMath, ESMATH_CLASS )
  ...
  /// @brief  Calculate sum of an input vector|numeric collection
  ///
  /// @param  p1 [in] Either collection of convertibles to numeric, or EsMathArrayReal object.
  /// @return         Accumulated sum, or an empty variant, if input is empty    
  ///
  ES_DECL_REFLECTED_CLASS_METHOD1(EsVariant, accumulate, cr_EsVariant);
