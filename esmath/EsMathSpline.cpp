...
EsMathSplineNode::EsMathSplineNode() ES_NOTHROW :
m_x(0),
m_xp(0),
m_a(0),
m_b(0),
...
EsMathSplineNode::EsMathSplineNode(double x, double xp, double a, double b, double c, double d) ES_NOTHROW :
m_x(x),
m_xp(xp),
m_a(a),
m_b(b),
...
EsMathSplineNode::EsMathSplineNode(const EsMathSplineNode& src) ES_NOTHROW :
m_x(src.m_x),
m_xp(src.m_xp),
m_a(src.m_a),
m_b(src.m_b),
...
EsMathSplineNode& EsMathSplineNode::operator=(const EsMathSplineNode& src) ES_NOTHROW 
{
  m_x = src.m_x;
  m_xp = src.m_xp;
  m_a = src.m_a;
...
public:
  ...
  const alglib::spline1dinterpolant& splineGet() const ES_NOTHROW { return m_spline; }
...
{
  std::unique_ptr<EsMathSpline> f = ES_MAKE_UNIQUE( EsMathSpline );
  f->m_dynamic = true;
